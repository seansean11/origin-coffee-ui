...
@Component({
  selector: 'app-Coffee-Farmer',
  templateUrl: './Coffee-Farmer.component.html',
  styleUrls: ['./Coffee.component.css'],
  providers: [CoffeeService]
})
export class CoffeeFarmerComponent implements OnInit {
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      ...
      "organic": this.organic.value || false,
